...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['travel-planner'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Budget', path: '/budgets', entity: 'budget', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
    { name: 'Itinerary', path: '/itineraries', entity: 'itinerary', service: AccessServiceEnum.PROJECT, icon: FiMap },
    { name: 'Todo', path: '/todos', entity: 'todo', service: AccessServiceEnum.PROJECT, icon: FiCheckSquare },
